...
function CertificatePage() {
  ...
  return (
    <DashboardLayout role="admin">
      <TrainingHistoryDashboard historyData={data} certificateData={certificateData} certificatesLoading={certificatesLoading} loading={loading} error={error} reload={reload} role="admin" />
    </DashboardLayout>
  );
}
